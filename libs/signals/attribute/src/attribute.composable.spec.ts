    ...
    describe('useAttribute', () => {
        ...
        describe('unit', () => {
                    ...
                    providers: [
                        {
                            ...
                            useValue: {
                                nativeElement: {
                                    getAttributeNS: jest.fn().mockReturnValue(initialAssignedValue)
                                }
                            }
                        },
            ...
            it('should call bindAttribute with the correct arguments', () => {
                TestBed.runInInjectionContext(() => {
                    ...
                    // Act
                    const value = useAttribute('name', { initialValue: 'foo', defaultValue: 'bar', namespace: 'my' });

                    // Assert
                    expect(bindAttributeSpy).toHaveBeenCalledWith('name', value, { defaultValue: 'bar', namespace: 'my' });
            ...
            describe('the signals initial value should be', () => {
                it.each([
                    'foo',
                    null
                ])('the initialValue, if defined', (value) => {
                    TestBed.runInInjectionContext(() => {
                        // Act
                        const result = useAttribute('name', { initialValue: value });
                ...
                it.each([
                    'bar',
                    null
                ])('the initial assigned value in the DOM if no initialValue has been defined', (value) => {
                    TestBed.runInInjectionContext(() => {
                        // Arrange
                ...
                it('the default value, if neither the initialValue, nor a DOM based value are defined', () => {
                    TestBed.runInInjectionContext(() => {
                        // Act
                        const result = useAttribute('name', { defaultValue: 'baz' });
        ...
        describe('integration', () => {
            ...
            class TestButtonComponent {
                ...
                readonly role = useAttribute('role', { initialValue: 'button' });

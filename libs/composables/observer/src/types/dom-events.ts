...
export type EventName<Target extends EventTarget> = CastToName<
    {
        [K in keyof DOMEventMapDefinitions]: DOMEventMapDefinitions[K] extends [infer TargetType, infer EventMap]
 ...
 */
export type EventType<Target extends EventTarget, Name extends string> = CastToEvent<GetEventType<Target, Name>>;

type GetEventType<Target extends EventTarget, Name extends string> = {
    [K in keyof DOMEventMapDefinitions]: DOMEventMapDefinitions[K] extends [infer TargetType, infer EventMap]
        ? Target extends TargetType
